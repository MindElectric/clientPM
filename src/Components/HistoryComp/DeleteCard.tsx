...
const DeleteCard = ({ notification }: { notification: notification }) => {
    ...
    return (
        <div className="flex flex-col flex-wrap rounded-lg bg-customTextbox">
            <div className="w-full h-10 bg-red-400 rounded-md" />
                ...
                <div className="flex flex-col text-lg">
                    <div className="mb-5">
                        <div className="flex">
                            ...
                            <span className="ml-40 font-bold whitespace-pre">Descripcion: </span> {notification.descripcion}
                        </div>
                    </div>
                    {/* <div className="mb-5">
